...
class MessagesUtil {
    ...
    companion object{
        fun getFullMessageFromConfig(plugin: PerWorldWarpsPlus, messagePath: String, replaces: Map<String, String>): String {
        ...
        fun getFullMessageListFromConfig(plugin: PerWorldWarpsPlus, messagePath: String, replaces: Map<String, String>): MutableList<String> {
            val messagesConfig: FileConfiguration = plugin.messagesConfigFile
